 ...
 */
const bool MFRC522Hack::MIFARE_OpenUidBackdoor(const bool logErrors) const {
	// Magic sequence:
 ...
 */
const bool MFRC522Hack::MIFARE_SetUid(const byte *const newUid, const byte uidSize, const bool logErrors) const {
 ...
 */
const bool MFRC522Hack::MIFARE_UnbrickUidSector(const bool logErrors) const {
